...
function displayl() {
    ...
    var dicg = [{ name: 'Anagha', r_No: 'URK20CS1147', dob: '18-04-02' },
    { name: 'Akshay', r_No: 'URK20CS0191', dob: '05-10-97'}];
    // console.log(dicg[0].name)
    for (var i = 0; i<dicg.length; i++) {
        sp.innerHTML += "<br>"+'Student Name:' + dicg[i].name +"<br>"+ 'Register_Number: ' + dicg[i].r_No + "<br>"+'Date of Brith: ' + dicg[i].dob + "<br>";
    }
}